...
// Syntax: 		mciSendString(click_menu, NULL, 0, NULL);
...
public:
	...
	int playScreen(int Level)
	{
		if (soundOn) {
			switch (Level) {
			case 1:	PlaySound(TEXT("song_game_1.wav"), NULL, SND_FILENAME | SND_ASYNC); break;
			case 2:	PlaySound(TEXT("song_game_2.wav"), NULL, SND_FILENAME | SND_ASYNC); break;
			case 3:	PlaySound(TEXT("song_game_3.wav"), NULL, SND_FILENAME | SND_ASYNC); break;
			case 4:	PlaySound(TEXT("song_game_4.wav"), NULL, SND_FILENAME | SND_ASYNC); break;
			case 5:	PlaySound(TEXT("song_game_5.wav"), NULL, SND_FILENAME | SND_ASYNC); break;
			default: break;
			}
		}
		graphic->clearBuffer();
